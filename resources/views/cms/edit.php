        ...
        <div class="bg-white shadow sm:rounded-lg p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="title" id="title" required value="<?= esc($post['title']) ?>"
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 border"><?= esc($post['excerpt'] ?? '') ?></textarea>
                </div>

                <div>
                    <label for="content" class="block text-sm font-medium text-gray-700">Content</label>
                    <textarea name="content" id="content" rows="12" required
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 border"><?= esc($post['content']) ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <?php if ($post['featured_image']): ?>
                        <p class="text-sm text-gray-500 mb-2">Current: <?= esc($post['featured_image']) ?></p>
                    <?php endif; ?>
